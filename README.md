# Step by step guide to develop a simple android application to upload the user’s location to the server via Intent Background service using Retrofit Networking library
